...
@section('judulhalaman','Pendapatan Ambarawa')
@section('judulpage','Tambah Pendapatan Museum Ambarawa')
@section('csstambahan')
<!--
...
@if ($errors->any())
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <form action="{{ URL('/ambarawa/tambah') }}" method="post" class="form-horizontal">
        <div class="box-body">
       ...
       <div class="col-sm-4">
          ...
          <div class="form-group">
           ...
           <div class="col-sm-2">
                    ...
                    <input type="number" class="form-control" name="volume_rts" id="volume_rts" placeholder="volume" required>
                     </div>
                     <div class="col-sm-4">
                              <input type="number" class="form-control" name="satuan_rts" id="satuan_rts"  placeholder="satuan_rts" required>
                               </div>
                     <div class="col-sm-4">

                       <input type="text" class="form-control" name="pendapatan_rts" id="pendapatan_rts" placeholder="Rp." readonly>
          ...
          <div class="form-group">
           ...
           <div class="col-sm-2">
                    ...
                    <input type="number" class="form-control" name="volume_sewa_ka" id="volume_sewa_ka" placeholder="volume" required>
                     </div>
                     <div class="col-sm-4">
                        <input type="number" class="form-control" name="satuan_sewa_ka" id="satuan_sewa_ka" placeholder="satuan_sewa_ka" required>
                     </div>
                     <div class="col-sm-4">
                      <input type="text" class="form-control" name="pendapatan_sewa_ka" id="pendapatan_sewa_ka" placeholder="Rp." readonly>
                    </div>
                  </div>
                </div>
