...
@section('judulhalaman','Stasiun Barang')
@section('judulpage','Stasiun Barang')
@section('csstambahan')
<!--
...
@section('konten')
  ...
  <div class="row">
     <div class="col-lg-5">
       <div class="box box-default color-palette-box">
         <div class="box-header with-border">
           <h3 class="box-title">Tambah Stasiun Barang</h3>
         </div>
         <div class="box-body">
     ...
     <div class="col-lg-7">
       <div class="box box-default color-palette-box">
         <div class="box-header with-border">
           <h3 class="box-title">Daftar Stasiun Barang</h3>
         </div>
             ...
             <table id="daftar-stasiun" class="table table-bordered table-striped">
                 ...
                 <tbody>
                   ...
                   <tr>
                     ...
                     <td>
                         @if(Auth::user()->level==3)
                         <form action="/stasiun/barang/cektombol" method="post">
                           <input type="hidden" name="id" value="{{$i->id}}">
                           {{csrf_field()}}
                            @if($i->stasiun_barang==1)
